...
function Card({ children, variant, className }: CardProps) {
  ...
  className?: string;
    ...
    sourceUrl: "https://react.dev/reference/react-dom/components/common#applying-css-styles",
  ...
  classes?: {
    ...
    sourceUrl: "https://mui.com/material-ui/customization/how-to-customize/#overriding-nested-component-styles",
